...
@router.get("/tools",
            openapi_extra={
                "mcp_description": "Get all available MCP tools that can be used for queries. You can use this to cpunt the number of tools or give response if someone asks what a particula tool does.",
                "mcp_scenarios": [
