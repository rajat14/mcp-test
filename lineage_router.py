...
@router.get(
    ...
    openapi_extra={
        "mcp_description": "Fetches lineage information for a specified dataset/table or column within a given namespace. "
                           "Users can specify whether they want to retrieve upstream and/or downstream lineage,lineage type as either column or table, as well as the depth of the lineage graph and want to include transformations or not."
    }
)
@initialize_transaction_data()
@timer_end()
